...
for i in list(range(1,100)):
    ...
    urls.append('https://rate.tmall.com/list_detail_rate.htm?itemId=544870390510&spuId=720523039&sellerId=346621366&order=3&currentPage=%s'%i)
...
size.extend(re.findall(re.compile('适用床尺寸:(.*?);'),content))
